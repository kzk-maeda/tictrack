...
### Phase 2 (P1 - デモ後)
- [x] 🔴🔄 2.1 認可ロジック共通化 — TDD で新モジュール作成 + リファクタリングで移行
- [x] 🔴 2.2 Router パラメータマッピング修正
- [ ] 🔴 2.3 環境変数バリデーション
...
### Phase 3 (P2 - プロダクション前)
- [x] 🔄 3.1 型定義の単一ソース化
- [x] 🔄 3.2 フロントエンド状態管理の SWR 統一
- [x] 🔴🔄 3.3 ドメインサービス層の導入 — TDD で新サービス作成 + リファクタリングで移行
- [x] 🔴🔄 3.4 集計ロジックの統一 — TypeScript 版に統一、未使用の Python Lambda 削除
